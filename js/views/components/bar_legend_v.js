define(["jquery", "underscore", "backbone","raphael"],
    function($, _, Backbone,Raphael) {
        ...
        var Bar_legend_v = Backbone.View.extend({
            ...
            move:function(x,y){
                this.labels_group.translate(x,y)
            },
            hide:function(){
                this.labels_group.hide();
            },
            show:function(){
                this.labels_group.show();
            },
            ...
            build_legend:function(){
                        ...
                        */
                        this.legend_label = this.paper.text(0,0,'This is my label');

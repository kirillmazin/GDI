define(["jquery", "underscore", "backbone", "raphael", "views/components/generic_component_v"],
    function($, _, Backbone, Raphael, Generic_component_v) {
        ...
        var Pies_revenue_v = Generic_component_v.extend({



            initialize: function(o) {
                Pies_revenue_v.__super__.initialize.apply(this);
                ...
                this.revenue_millions = this.amount / 10000;

define(["jquery", "underscore", "backbone","raphael","views/components/dots_v","views/filters/filtering_menu_v","views/sections/dots_section_v","views/components/legend_v","collections/movies_c",
...
"views/components/pie_chart_legend_v","views/chart_generic_v","views/sections/revenue_averages_section_v"],
    function($, _, Backbone,Raphael, Dots_v, Filtering_menu_v, Dots_section_v,Legend_v, Movies_c, Dots_legend_v,Pie_chart_legend_v,Chart_generic_v, Revenue_averages_section_v) {
        ...
        var Chart_dots_v = Chart_generic_v.extend({
